...
struct Settings {
    ...
    static let redColor = UIColor(red: 207/255, green: 88/255, blue: 74/255, alpha: 1)
    ...
    static let currentDate = NSDate(timeIntervalSince1970: 1440008981) // 1440168981: 21/08/15 14:56

...
//  Badget
//
//  Created by Jasper Van Damme on 27/05/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "be.devine.nd.Badget" in the application's documents Application Support directory.
